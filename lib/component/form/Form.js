Ext.define( 'extAdmin.component.form.Form',
{
	...
	initLocalizable : function()
	{
		...
		Ext.apply( me.backend,  {
			xtype : 'localizable'
		});
		
		Ext.applyIf( me.backend, {
			listeners : {}
		});
		...
		Ext.apply( me.backend.listeners, {
	...
	createForm : function()
	{
		...
		be.on( 'readonlychange', function( form, readOnly ) {
			// TODO disable submit btn on readOnly === true
		});
	...
	updateFlags : function()
	{
		...
		var bar = me.localizationsToolbar;
