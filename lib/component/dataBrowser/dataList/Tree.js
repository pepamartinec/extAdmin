Ext.define( 'extAdmin.component.dataBrowser.dataList.Tree',
{
	...
	{
		var me = this,
		    config = extAdmin.component.dataBrowser.DataBrowser.pickServerConfig( me.module, me.getDefaultConfig() ).tree;
