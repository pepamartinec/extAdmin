...
{	
	...
	constructor : function( dataList, config )
	{
		var me = this;
...
//		me.module.initActions( 'dataList', { dataList : me });
		...
		if( config.enableToolbar !== false ) {
			me.activateToolbar( dataList, config.barActions );
		}
...
//		me.module.updateActionsStates();
	...
	activateToolbar : function( dataList, barActions )
	{			
		var actionsBar = Ext.create( 'extAdmin.component.dataBrowser.actionDock.Toolbar', {
			dock : 'top',
