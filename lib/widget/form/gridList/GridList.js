Ext.define( 'extAdmin.widget.form.gridList.GridList',
{
	...
	initComponent : function()
	{
		...
		// enable inline editor ( cell editing )
		var plugins = [];
		if( o.editing )
		{
			me.dataModelName = extAdmin.Model.createAnonymous( me, { fields : o.editing.fields });
		...
		// add button for inserting record directly to grid
		if( o.editing && o.editing.newButton ) 
		{
			var newBtn = Ext.apply( {}, o.editing.newButton, {
				handler: function(){
					me.addDirectlyNewRecord();
                }
			});
