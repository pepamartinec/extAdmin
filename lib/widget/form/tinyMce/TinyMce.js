	...
	statics : {
		setup : {
			...
			advanced : {
				...
				theme_advanced_buttons2 : 'link,unlink,anchor,image,galleryBrowser,|,visualchars,nonbreaking,pagebreak',
		...
		showFileBrowser : function( fieldName, url, type, window )
		{
			switch( type ) {
				case 'image':
					Ext.create( 'extAdmin.popup.Lookup', {
						...
						onSelection : function( images ) {
							...
							window.document.getElementById( fieldName ).value = image.get('thumbFilename');
						}
					});
					break;
				...
				default:
					...
					tinyfck = win;
					window.open('../../filemanager/browser.html?Connector=connectors/php/connector.php', 'tinyfck', 'modal,width=600,height=600');
					break;
			}
		}
	},
