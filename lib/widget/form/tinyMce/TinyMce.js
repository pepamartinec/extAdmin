				...
				case 'image':
					Ext.create( 'extAdmin.popup.Lookup', {
						...
						onSelection : function( images ) {
							...
							window.document.getElementById( 'title' ).value = image.get('title');
							window.document.getElementById( 'alt' ).value = image.get('title');
							window.document.getElementById( 'prev' ).innerHTML = "<img id='previewImg' border='0' onload='ImageDialog.updateImageData(this, 1);' src='"+ extAdmin.baseHref + image.get('thumbFilename') +"'>";
							window.document.getElementById( 'title' ).value = image.get('title');
							window.document.getElementById( 'alt' ).value = image.get('title');
							window.document.getElementById( 'prev' ).innerHTML = "<img id='previewImg' border='0' onload='ImageDialog.updateImageData(this, 1);' src='"+ extAdmin.baseHref + image.get('thumbFilename') +"'>";
						}
