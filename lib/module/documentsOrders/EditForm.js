			...
			columns : {
				...
				vatRateValue : {
					...
					renderer : function( value, metaData, record ) {
						var currentVatRate  = value,
						    originalVatRate = record.get( 'originalVatRateValue' );
						
						value = value +'%';
						
						if( currentVatRate != originalVatRate ) {
							value = '<span title="Standardní DPH: '+ originalVatRate +'%">'+ value +'</span>';
							metaData.tdCls = 'modified';
						}
