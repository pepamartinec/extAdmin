Ext.define( 'extAdmin.Module',
{
	...
	uses : [
		'extAdmin.action.generic.Dummy',
		'extAdmin.action.dataBrowser.Filter',
		'extAdmin.action.dataBrowser.SwitchView',
		...
		'extAdmin.action.dataList.Download'
	],
	...
	initActions : function( type, config )
	{
		...
		for( var actionName in definitions ) {
			...
			var actionType = inspirio.String.ucfirst( definition.type ),
