Ext.define( 'extAdmin.action.ActionManager',
{
	...
	uses : [
		...
		'extAdmin.action.form.Cancel',
		'extAdmin.action.form.Submit',
		
		'extAdmin.action.module.Redirect',
		
		'extAdmin.action.record.Download',
		'extAdmin.action.record.Form',
		'extAdmin.action.record.Remove',
	...
	factoryActions : function( actionsDef, factoryConfig )
	{
		...
		for( var name in actionsDef ) {
			...
			var config = Ext.Object.merge( { name : name }, factoryDef, actionDef );
